...
\tilde{c}t &= \sigma_c(W_c x_t + U_c h{t-1} + b_c), \\
...
$$
\text{Attn}(Q,K,V)_t=\frac{{\sum_{i=1}^{T}}\exp(q_t^\top k_i) \odot v_i}{\sum_{i=1}^{T}\exp(q_t^\top k_i)}
$$
...
![image.png](RWKV%20299559a021ef80a1b872f178ff8c5f9d/821fad7d-7a21-460e-81c3-e054ffa0a6ae.png)
...
![image.png](RWKV%20299559a021ef80a1b872f178ff8c5f9d/41ddb454-a856-431b-b37d-b115d0022cfa.png)
